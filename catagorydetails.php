            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-4 col-sm-7">
                        <div class="single-product-image-inner">
                            ...
                            <?php
                                $vid=$_GET['updateid'];
                                $conn = connect_to_db();
                                $ret=mysqli_query($conn,"SELECT * FROM productupload where id='$vid' ORDER BY ID LIMIT 3");
                                while ($row=mysqli_fetch_array($ret)) {
                                ?>
                    ...
                    <div class="col-md-4 col-sm-5">
                                ...
                                $vid=$_GET['updateid'];
                                $conn = connect_to_db();
                                $ret=mysqli_query($conn,"SELECT * FROM productupload where id='$vid' ORDER BY ID LIMIT 1");
                                while ($row=mysqli_fetch_array($ret)) {
                                ?>
                    ...
                    <?php
                        ...
                        <div class="col-md-12">
                            <div class="col-md-6 single-new-trends marginBottom20">
                                <a href="catagorydetails.php?updateid=<?php echo $row["id"]; ?>&cat=<?php echo $row["catagory"]; ?>"><img width="100%" style="height:120px;border: 1px solid #999;" src="<?php  echo $row['image'];?>" alt=""></a>
                                <div class="overlay-content"> <a href="catagorydetails.php?updateid=<?php echo $row["id"]; ?>&cat=<?php echo $row["catagory"]; ?>" class="btn-small">New</a></div>
                            </div>
                            <div class="col-md-6">
